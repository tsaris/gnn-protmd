...
class GConvLSTM(torch.nn.Module):
    ...
    def _create_input_gate_parameters_and_layers(self):
        ...
        self.conv_x_i = GCNConv(in_channels=self.in_channels,
                                out_channels=self.out_channels)

        self.conv_h_i = GCNConv(in_channels=self.out_channels,
                                out_channels=self.out_channels)
    ...
    def _create_forget_gate_parameters_and_layers(self):
        ...
        self.conv_x_f = GCNConv(in_channels=self.in_channels,
                                out_channels=self.out_channels)

        self.conv_h_f = GCNConv(in_channels=self.out_channels,
                                out_channels=self.out_channels)
    ...
    def _create_cell_state_parameters_and_layers(self):
        ...
        self.conv_x_c = GCNConv(in_channels=self.in_channels,
                                out_channels=self.out_channels)

        self.conv_h_c = GCNConv(in_channels=self.out_channels,
                                out_channels=self.out_channels)
    ...
    def _create_output_gate_parameters_and_layers(self):
        ...
        self.conv_x_o = GCNConv(in_channels=self.in_channels,
                                out_channels=self.out_channels)

        self.conv_h_o = GCNConv(in_channels=self.out_channels,
                                out_channels=self.out_channels)
    ...
    def _set_cell_state(self, X, C):
        if C is None:
            C = torch.zeros(X.shape[0], self.out_channels).to(device)
        return C
