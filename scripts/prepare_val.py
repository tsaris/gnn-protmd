    ...
    with open(path, 'r') as f:
        ...
        while line:
            ...
            if line[0] == 'ENDMDL':
                ...
                # Save the file
                file_name = "/gpfs/alpine/world-shared/stf011/atsaris/datagnn/datagnn_ras_2020/graph_full_kRas_val/%d_ras_%s.npz"%(cnt, label)
...
parse_pdb("/gpfs/alpine/world-shared/bif128/for_Aris/ras_g12d/holo_inactive/run_9_first20ish_ns.pdb", "on")
parse_pdb("/gpfs/alpine/world-shared/bif128/for_Aris/ras_g12d/apo_active/run_9_first20ish_ns.pdb", "off")
